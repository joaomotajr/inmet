...
Public Class ExportOptions
  ...
  Dim mPassword As String = ""
    ...
    Public Const BW_TIFF_G4 As String = "tiffg4"
    Public Const BW_TIFF_LZW As String = "tifflzw"
    Public Const GRAY_TIFF_NC As String = "tiffgray"
    Public Const GRAY_PNG = "pnggray"
    Public Const GRAY_JPG = "jpeggray"
    Public Const COLOR_TIFF_RGB As String = "tiff24nc"
    Public Const COLOR_TIFF_CMYK As String = "tiff32nc"
    Public Const COLOR_TIFF_CMYK_SEP As String = "tiffsep"
    Public Const COLOR_PNG_RGB As String = "png16m"
    Public Const COLOR_JPEG = "jpeg"
